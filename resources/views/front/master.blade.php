...
<header id="header" class="hidden-xs">
    ...
    <div class="container">
    	<div class="row">
    		<div class="col-sm-2">
					<div class="logo">
						<a href="{{url('/')}}" class="logo-container"><img src="{{ asset('img/logo.jpg') }}" /></a></div></div>
    		<div class="col-sm-8">
				<div class="nav-link">
					<ul>
		    ...
		    <div class="col-sm-2">
				<div class="nav-btns">
					<div class="nav-cart">
						<a href="{{url('cart')}}"><img src="{{ asset('img/cart.png')}}"/>
						 CART({{Cart::count()}})
					 </a>
					</div>
				</div>
...
<header id="header" class=" hidden-sm hidden-md hidden-lg">
	...
	<div class="logo"><a href="index.php"><img src="{{ asset('img/cart.png')}}" alt=""  /></a></div>
	<div class="m-cart">
		<div class="nav-btns">
			<div class="nav-cart">
...
<script type="text/javascript" src="{{ URL::asset('js/multiple-accordion.js') }}"></script>
<script type="text/javascript" src="{{ URL::asset('js/jquery.nice-select.js') }}"></script>
<script type="text/javascript" src="{{ URL::asset('js/jquery.bootstrap-responsive-tabs.js') }}"></script>
<script>
$(function() {
    var html = $('html, body'),
